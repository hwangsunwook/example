...
?>
<br/>
<form name="iForm" method="post" action="memo_modify_update.php" style="margin:0px;">
<input type="hidden" name="m_idx" value="<?=$data[m_idx]?>">
<table style="width:500px;height:50px;border:5px #CCCCCC solid;">
    <tr>
        <td align="center" valign="middle" style="font-zise:15px;font-weight:bold;">메모 수정하기</td>
    </tr>
</table>
<table style="width:500px;height:50px;border:0px;">
    <tr>
        <td align="center" valign="middle" style="width:100px;height:50px;">이름</td>
        <td align="center" valign="middle" style="width:400px;height:50px;"><input type="text" name="m_name" style="width:380px;" value="<?=$data[m_name]?>"></td>
    </tr>
    <tr>
        <td align="center" valign="middle" style="width:100px;height:50px;">이메일</td>
        <td align="center" valign="middle" style="width:400px;height:50px;"><input type="text" name="m_email" style="width:380px;" value="<?=$data[m_email]?>"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td align="center" valign="middle" style="width:400px;height:50px;"><input type="text" name="m_memo" style="width:380px;" value="<?=$data[m_memo]?>"></td>
    </tr>
    <tr>
